        ...
        <div class="wrapper">
            <div class="document-content">
                <div class="document-about">
                    ...
                    <a href="#" class="document-about__button btn">
                ...
                <div class="document-slider-wrap">
                    <ul class="document-slider">
                        <li class="document-slider__item">
                            <a href="img/document/document.jpg" target="_blank" class="document-slider__link">
                                <img src="img/document/document.jpg" alt="document" class="document-slider__image">
                            </a>
                        </li>
                        <li class="document-slider__item">
                            <a href="img/document/document.jpg" target="_blank" class="document-slider__link">
                    ...
                    <button class="document-slider__button document-slider__button_prev">
                        <img src="img/document/slider__arrow.png" alt="prev" class="document-slider__icon">
                    </button>
                    <button class="document-slider__button document-slider__button_next">
                        <img src="img/document/slider__arrow.png" alt="next" class="document-slider__icon document-slider__icon_revers">
                    </button>
                </div>
            </div>
        </div>
