...
<section class="developer">
    ...
    <div class="page-top page-top_developer animate">
            ...
            <ul class="developer__slider js-developer__slider">
                <li>
                    <a href="https://chicago.kiev.ua/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/chicago_logo_white.svg" alt="Chicago Logo">
                    </a>
                </li>
                <li>
                    <a href="http://new-york.com.ua/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/new_york_logo_white.svg" alt="New York Logo">
                    </a>
                </li>
                <li>
                    <a href="https://sanfrancisco.com.ua/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/san-francisco_logo_white.svg" alt="San Francisco Logo">
                    </a>
                </li>
                <li>
                    <a href="http://kandinsky-residence.com.ua/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/kandinsky_logo_white.svg" alt="kandinskiy Logo">
                    </a>
                </li>
                <li>
                    <a href="http://resident.house/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/resident_logo_white.svg" alt="Resident Logo">
                    </a>
                </li>
                <li>
                    <a href="https://rybalsky.com.ua/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/rybalsky_logo_white.svg" alt="kandinskiy Logo">
                    </a>
                </li>
                <li>
                    <a href="https://einstein.house/" target="_blank">
                        <img src="/wp-content/themes/washington/assets/img/developer/einstein_logo_white.svg" class="developers__einstein-logo" alt="Einstein Logo">
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="developer__main-content wrapper animate">
        <div class="developer__location">
            ...
            <div class="developer__location-text">
                ...
                <ul class="developer__location-list">
                    <li class="developer__location-list-item developer__location-list-item_addr"><?=$links[2];?></li>
                    <li class="developer__location-list-item developer__location-list-item_tel"><a href="#"><?=$links[3];?></a></li>
                    <li class="developer__location-list-item developer__location-list-item_email"><a href="mailto:<?=$links[4];?>">
                            <?=$links[4];?></a></li>
                </ul>
            </div>
        ...
        <div class="developer__about">
            <ul>
                <li class="developer__about-item developer__about-item_1">
                    ...
                    <div class="developer__about-item-text developer__about-item-text_1"><?=$links[5];?></div>
                </li>
                <li class="developer__about-item developer__about-item_2">
                    ...
                    <div class="developer__about-item-text developer__about-item-text_2"><?=$links[6];?></div>
                </li>
                <li class="developer__about-item developer__about-item_3">
                    ...
                    <div class="developer__about-item-text developer__about-item-text_3"><?=$links[7];?></div>
                </li>
            </ul>
        </div>
    </div>
