...
if(stristr($uri[$ver], 'floor-') === FALSE) {
    echo '"earth" не найдена в строке';
}
else{
    echo  'floor glor';
    $floor = str_replace('floor-', '',$uri[$ver]);
    print_r($uri);
    print_r($floor);

}
?>
<?if($floor && empty($_GET['flat'])){
//    echo 'Это этаж';?>
            ...
            <div class="select-apartmens-wrap">
                <div class="select-apartmens-top">
                    ...
                    <div class="select-floor">
                        ...
                        <p class="select-floor__text"><?=$floor?> поверх</p>
                        <a href="#" class="select-floor__button">
...
elseif($floor && !empty($_GET['flat'])) {
    ...
    <div class="wrapper">
            ...
            <div class="page-top__wrapper">
                ...
                <div class="page-top__links">
                    <ul>
                        ...
                        <li>
                            <a href="/project/floor-<?=$floor?>/">Обрати поверх</a>
                        </li>
                        <li>
                            <span class="page-top__line"></span>
                        </li>
        ...
        <div class="select-apartmens-wrap select-apartmens-wrap_height_auto">
            <div class="select-apartmens-top">
                <a href="/project/floor-<?=$floor?>/" class="select-button select-button__flat-plan btn">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/select-appartmets/long-arrow.png" alt="icon" class="select-button__icon select-button__icon_transform">
                    <span class="select-button__text btn__text">Обрати квартиру</span>
                </a>
